...
So here's the question: is it possible to design a verifiable set of rules and procedures that draw out the depth and reasoning quality that AI should be capable of?
