...
tags: ["AI", "toolchain", "evolution-path", "tutorial", "chatgpt", "gemini", "gpt", "chatgbt", "claude"]
categories: ["ai-path"]
toc: true
cover:
  image: "cover.png"
...
|----------|------------|--------------|-----------|
| **ChatGPT** | Dual system | **Saved Memories** (explicit; you tell it what to remember) + **Chat History Reference** (implicit; it extracts preferences from past conversations). Limited availability for free users | Partial |
...
*That wraps up Week 1. Next up, Part 2 dives into Prompt fundamentals, from vague questions to precise instructions. (Part 2 coming soon)*
