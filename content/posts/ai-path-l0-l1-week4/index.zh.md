...
cover:
  image: "cover.png"
  alt: "水彩风格：木工台上整齐摆放的玻璃罐、皮革笔记本和精选工具，一个两层抽屉柜子象征知识管理分区，一切井井有条"
---
...
> 📋 **第三周回顾**
> - [系列主文：把 AI 变成协作伙伴](/posts/2026/05/ai-path-l0-l1-week3/)（追问迭代、上下文管理、角色扮演）
> - [今日练习：一次 15 轮长对话实验](/posts/2026/05/ai-practice-15-turn-conversation/)
> - [实例拆解：长对话翻车实录](/posts/2026/05/ai-3-long-conversation-fails/)
> - [技巧卡：追问进阶——暴露隐含假设](/posts/2026/05/ai-follow-up-hidden-assumptions/)
> - [技巧卡：角色扮演——魔鬼代言人](/posts/2026/05/ai-devils-advocate-role-play/)
...
| 场景 | 推荐工具 | 原因 |
|------|---------|------|
| 深度研究 | Kimi / 秘塔搜索 / 天工 AI | 中文互联网搜索更全，无需出墙，Kimi 支持超长上下文，适合长文档分析 |
...
- **编程辅助（代码补全）**：如果你写代码，Trae 和通义灵码是更适合国内开发者的选择——在国内网络环境下可直接使用，免费额度也比 Copilot Free（免费聊天仅 50 条/月）更宽松。按你的技术栈和生态偏好选一个就行。
...
下一篇是毕业考核——检验你四周的练习成果，同时看看 L1 之后的路怎么走。→ [第五篇：毕业考核与下一步](/posts/2026/05/ai-path-l0-l1-graduation/)
