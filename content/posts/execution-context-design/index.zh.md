...
![ANSI 污染链：干净数据流经 evaluator 节点时被终端颜色代码污染，scorer 在乱码上输出整齐但错误的 8 张评分卡](ansi-pollution-chain.png)
...
![汇总错误 vs 独立评分：左侧四条数据带汇入漏斗变灰差异消失，右侧四个独立管道各自保持颜色差异一目了然](aggregation-vs-independent.png)
...
![v1 vs v2 结论翻转：相同的实验设计，左侧两节点红圈警告产出模糊结论，右侧隔离屏障修复后产出明确结果](conclusion-flip.png)
