...
tags: ["AI", "工具链", "进化路径", "教程", "claude", "deepseek api", "kimi api"]
categories: ["ai-path"]
toc: true
series: ["AI 之路初阶升级指南"]
cover:
  image: "cover.png"
  alt: "水彩风格：一条蜿蜒小路通向山顶的小旗帜，远处是更广阔的山脉和云层"
---
...
预计的 L1→L2 升级教程会涉及命令行操作或编程基础，届时再见。

---

![三个方向](illustration-paths.png)
