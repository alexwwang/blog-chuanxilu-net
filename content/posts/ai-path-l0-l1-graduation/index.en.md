...
tags: ["AI", "toolchain", "evolution-path", "tutorial", "claude", "deepseek api", "kimi api"]
categories: ["ai-path"]
toc: true
...
|------|-------|-------------|
| [Part 1](/en/posts/2026/05/ai-path-l0-l1-week1/) | Understanding Your Tools | LLM fundamentals (not a search engine), working memory vs. long-term memory, mainstream platforms and specialized tools |
| [Part 2](/en/posts/2026/05/ai-path-l0-l1-week2/) | From Vague Questions to Precise Instructions | The RBGO prompt framework, Chain-of-Thought reasoning, format constraints |
| [Part 3](/en/posts/2026/05/ai-path-l0-l1-week3/) | Turning AI Into Your Collaboration Partner | Iterative follow-up questions, context management (new conversations / progress summaries / chunked processing), role-playing |
| [Part 4](/en/posts/2026/05/ai-path-l0-l1-week4/) | Building Your Personal System | Prompt library, scenario-to-tool mapping (international and China options), layered knowledge management |
